...
//  String s=String(sweepid);//Read the serial data and store it
//  Serial.println(s);
  //Serial.print(" id=");
 // Serial.println(id);
   for(i=0;i<12;i++){
   ...
   // http.begin(client,"http://192.168.43.35/test/credits.php?card="+card+"&points="+points);              //Specify request destination
   // int httpCode = http.GET();
